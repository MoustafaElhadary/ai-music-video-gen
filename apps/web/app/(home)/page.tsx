					...
					<div className="mx-auto max-w-7xl">
						...
						<div className="mt-8 border-2 border-dashed border-blue-700 p-6 text-blue-700 relative rounded-lg">
							...
							<p className="mx-auto mb-8 max-w-2xl text-center text-lg">
								Giddy&apos;s got your back! We&apos;re the AI wizards turning
								your wildest ideas into mind-blowing music videos. Perfect for
								surprising your squad, serenading your crush, or just flexing
